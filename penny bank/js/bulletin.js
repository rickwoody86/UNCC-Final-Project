...
var initialArray = ["Clean your room" , "Feed the Dog", "Mow the Grass", "Set the Table", "Take out the Trash", "Water the Plants", "Vacuum the Living Room", "Rake the Leaves", "Walk the Dog", "Put up the Dishes"];
